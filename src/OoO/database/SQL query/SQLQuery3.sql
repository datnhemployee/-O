...
DROP TRIGGER TRG_AFTER_INS_THE
GO
...
END
GO
DROP TRIGGER TRG_INSTEAD_OF_DEL_THE
GO
...
END
GO
DROP TRIGGER TRG_AFTER_UPD_THE
GO
...
END
GO
DROP trigger TRG_AFTER_DEL_THE
GO
...
END
GO
DROP TRIGGER TRG_AFTER_INS_BUOC
GO
...
END 
DROP TRIGGER TRG_AFTER_UPD_BUOC
GO
...
END
GO
DROP trigger TRG_AFTER_DEL_BUOC
GO
...
END
GO
DROP TRIGGER TRG_AFTER_INS_OOOTHE
GO
...
END
GO
DROP TRIGGER TRG_AFTER_DEL_OOOTHE
GO
...
DELETE FROM OOO
DELETE FROM BANG WHERE BANGID = 1 
DELETE FROM THE WHERE THEID = 1
